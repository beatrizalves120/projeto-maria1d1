...
if(isset($_POST['cadastra'])){
    ...
    $sql = "INSERT INTO maria_1d (nome, email, mensagem) VALUES ('$nome', '$email', '$msg')";
...
<?php
$seleciona = mysqli_query($conexao, "SELECT * FROM maria_1d ORDER BY id DESC");
while($res = mysqli_fetch_assoc($seleciona)){
    echo '<ul class="maria_1d">';
